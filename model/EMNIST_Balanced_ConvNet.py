...
def get_model_files():
    ...
    model_balanced = os.path.join(model_dir, "model_file", "model_emnist_balanced_conv.ckpt")
    model_bymerge = os.path.join(model_dir, "model_file", "model_emnist_bymerge_Conv.ckpt")
